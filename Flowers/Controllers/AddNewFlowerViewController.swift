//
//  AddNewFlowerViewController.swift
//  Flowers
//
//  Created by Artem Vorobev on 22.08.2022.
//

import UIKit
import RealmSwift

class AddNewFlowerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor().colorFromHex("FBDDE7")
        title = "Добавить Цветок"
        
        if #available(iOS 13.0, *) {
                    let navBarAppearance = UINavigationBarAppearance()
                    navBarAppearance.configureWithOpaqueBackground()
                    navBarAppearance.backgroundColor = UIColor().colorFromHex("CA587F")
            navBarAppearance.largeTitleTextAttributes = [
                NSAttributedString.Key.foregroundColor : UIColor().colorFromHex("FBDDE7")
            ]
            ...
            navigationController?.navigationBar.tintColor = UIColor().colorFromHex("ECFBDE")
                } else {
                    navigationController?.navigationBar.barTintColor = UIColor().colorFromHex("ECFBDE")
                }
        ...
        tableView.backgroundColor = UIColor().colorFromHex("FBDDE7")
...
extension AddNewFlowerViewController: UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.flowerName.text = dataStrings[indexPath.row]
...
extension AddNewFlowerViewController: UITextViewDelegate{
